      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <p className="font-medium capitalize">{pokemon.habitat || "Unknown"}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Generation</p>
            <p className="font-medium capitalize">{pokemon.generation}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Growth Rate</p>
            <p className="font-medium capitalize">{pokemon.growthRate}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Base Happiness</p>
            <div className="flex items-center gap-1">
              <Heart className="h-4 w-4 text-red-500" />
              <span className="font-medium">{pokemon.baseHappiness}</span>
            </div>
          </div>
        </div>
      </CardContent>
